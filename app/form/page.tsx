...
export default function Preferences() {
	...
	useEffect(() => {
		...
		if (savedPreferences) {
			...
			const cuisines = decapitalize(parsed.cuisines) as string[]
			setIndonesian(cuisines.includes('indonesian'))
			setWestern(cuisines.includes('western'))
			setAsian(cuisines.includes('asian'))
			setMediterranean(cuisines.includes('mediterranean'))
	...
	return (
		<div className='min-h-screen bg-linear-to-br from-emerald-50 via-blue-50 to-purple-50 py-6 sm:py-12 px-4 sm:px-6 lg:px-8'>
